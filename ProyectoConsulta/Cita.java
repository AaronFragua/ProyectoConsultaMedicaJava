        ...
        while (!idValido) {
            ...
            if (input.matches("\\d+")) { 
                ...
                if (citaEncontrada != null) {
                    ...
                    System.out.println("No se ha encontrado ninguna cita con ese ID. Inténtalo de nuevo.");
                }
            } else {
                System.out.println("Por favor, introduce un ID válido que contenga solo dígitos.");
            }
        }
