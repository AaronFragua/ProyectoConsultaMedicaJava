...
public class Medico extends Persona{
    ...
    public static Medico anhadirMedico() {
        ...
        while (!cont) {
            ...
            if (miDNI.matches("[0-9]{8}[A-Za-z]{1}")) {
                ...
                System.out.println("Introduce un DNI validoo (6 numeros y una letra).");
            }
        }
        ...
        while (!cont) {
            ...
            if (miNombre.matches("[A-Za-z ]+")) {
                ...
                System.out.println("Introduce un nombre del medico valido.");
            }
        }
        ...
        while (!cont) {
            ...
            if (sc.hasNextInt()) {
                ...
                if (miEdad >= 1 && miEdad <= 110) {
                    ...
                    System.out.println("La edad debe ser entre 1 y 110 anhos.");
                }
            } else {
    ...
    public static Medico encontrarMedico(List<Medico> medicos) {
        ...
        while (!dniValido) {
            System.out.println("Introduce el DNI del medico a eliminar: ");
            ...
            if (miDNI.matches("[0-9]{8}[A-Za-z]")) {
                ...
                if (medicoEncontrado != null) {
                    ...
                    System.out.println("No se ha encontrado un medico con ese DNI. Intentalo de nuevo.");
                }
            } else {
                System.out.println("DNI no valido. Introduce un DNI con 8 numeros y una letra.");
            }
        }
