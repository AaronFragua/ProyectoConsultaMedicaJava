    ...
    public static Enfermero anhadirEnfermero() {
        ...
        while (!cont) {
            ...
            if (miDNI.matches("[0-9]{6}[A-Za-z]{1}")) {
                ...
                System.out.println("Introduce un DNI valido (6 numeros y una letra).");
            }
        }
        ...
        while (!cont) {
            ...
            if (miNombre.matches("[A-Za-z ]+")) {
                ...
                System.out.println("Introduce un nombre del enfermero valido.");
            }
        }
        ...
        while (!dniValido) {
            ...
            if (miDNI.matches("[0-9]{8}[A-Za-z]")) {
                ...
                if (enfermeroEncontrado != null) {
                    ...
                    System.out.println("No se ha encontrado un enfermero con ese DNI. Intentalo de nuevo.");
                }
            } else {
